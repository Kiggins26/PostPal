...
class MyApp:
    def __init__(self, master):
        ...
        self.logo_image = tk.PhotoImage(
            file="logo.png"
        )  # Replace "your_logo.png" with your actual image file
        ...
        self.file_path_label = tk.Label(
            self.top_frame, text="Selected File/Directory:", fg=fg_color, bg=bg_color
        )
        ...
        self.ranking_checkbox_checkbox = tk.Checkbutton(
            self.middle_frame,
            text="Rank Photos",
            variable=self.ranking_checkbox_var,
            fg=fg_color,
            bg=bg_color,
        )
        ...
        self.finddup = tk.Checkbutton(
            self.middle_frame,
            text="Find Duplicates",
            variable=self.finddup_var,
            fg=fg_color,
            bg=bg_color,
        )
        ...
        self.autoedit = tk.Checkbutton(
            self.middle_frame,
            text="Edit with AI",
            variable=self.autoedit_var,
            fg=fg_color,
            bg=bg_color,
        )
    ...
    def browse_file(self):
        ...
        )  # You can use askdirectory() for directories
        if file_path:
    ...
    def submit(self):
        ...
        if ranking_checkbox == True:
            ...
            image_rank_dic = dict(
                sorted(image_rank_dic.items(), key=lambda item: item[1], reverse=True)
            )
